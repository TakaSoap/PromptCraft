<template>
    <div style="height: 100vh; position: relative">
        <n-layout position="absolute">
            <n-layout-header class="header">
                ...
                <n-space>
                    <n-button size="small" quaternary @click="showAPIKeyModal">
                        ...
                        <div class="menu-text">Set API Key</div>
                    </n-button>
            ...
            <n-layout has-sider class="content-layout" position="absolute">
            ...
            <n-layout-footer class="footer" position="absolute">
                <n-text>
                    Released under
                    <n-button text type="tertiary" tag="a" href="https://opensource.org/license/mit/" target="_blank"> the MIT License </n-button>
                </n-text>
                <n-divider vertical />
    ...
    <n-modal v-model:show="generalStore.isAPIKeyModalVisible" preset="card" title="Set OpenAI API Key" style="width: 500px">
        <n-input type="password" show-password-on="mousedown" v-model:value="generalStore.apiKey" placeholder="Input your OpenAI API Key Here" />
        <template #footer>
            <n-space justify="end">
                <n-button secondary type="primary" @click="generalStore.isAPIKeyModalVisible = false"> Confirm </n-button>
            </n-space>
        </template>
    </n-modal>
</template>
